...
<section id="our-partners">
    <div class="text-center">
        ...
        <hr class="bg-white mb-3 mt-0 d-inline-block mx-auto" style="width: 100px; height:3px;">
        <p class="p-text text-white mb-5">List of companies collaborating with BlockDev</p>
    </div>
    ...
    <div class="row text-center mt-5">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-md-4 mt-5">
                <button type="button" class="btn btn-lg btn-outline-light btn-rounded">Check out our available positions</button>
            </div>
        </div>
    </div>
</section>
